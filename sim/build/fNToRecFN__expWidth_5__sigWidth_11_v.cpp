//========================================================================
// VfNToRecFN__expWidth_5__sigWidth_11_v.cpp
//========================================================================
...
#include "obj_dir_fNToRecFN__expWidth_5__sigWidth_11/VfNToRecFN__expWidth_5__sigWidth_11.h"
#include "stdio.h"
#include "stdint.h"
#include "verilated.h"
...
#if VLINETRACE
#include "obj_dir_fNToRecFN__expWidth_5__sigWidth_11/VfNToRecFN__expWidth_5__sigWidth_11__Syms.h"
#include "svdpi.h"
#endif
...
extern "C" {
  ...
  } VfNToRecFN__expWidth_5__sigWidth_11_t;

  // Exposed methods
  VfNToRecFN__expWidth_5__sigWidth_11_t * create_model( const char * );
  void destroy_model( VfNToRecFN__expWidth_5__sigWidth_11_t *);
  void eval( VfNToRecFN__expWidth_5__sigWidth_11_t * );
  void assert_en( bool en );

  #if VLINETRACE
  void trace( VfNToRecFN__expWidth_5__sigWidth_11_t *, char * );
  #endif
...
VfNToRecFN__expWidth_5__sigWidth_11_t * create_model( const char *vcd_filename ) {

  VfNToRecFN__expWidth_5__sigWidth_11_t * m;
  VfNToRecFN__expWidth_5__sigWidth_11   * model;

  Verilated::randReset( 0 );

  m     = (VfNToRecFN__expWidth_5__sigWidth_11_t *) malloc( sizeof(VfNToRecFN__expWidth_5__sigWidth_11_t) );
  model = new VfNToRecFN__expWidth_5__sigWidth_11();
...
void destroy_model( VfNToRecFN__expWidth_5__sigWidth_11_t * m ) {

  #if VM_COVERAGE
    VerilatedCov::write( "coverage.dat" );
  #endif

  VfNToRecFN__expWidth_5__sigWidth_11 * model = (VfNToRecFN__expWidth_5__sigWidth_11 *) m->model;
...
void eval( VfNToRecFN__expWidth_5__sigWidth_11_t * m ) {
...
#if VLINETRACE
void trace( VfNToRecFN__expWidth_5__sigWidth_11_t * m, char* str ) {
  ...
  svSetScope( &model->__VlSymsp->__Vscope_fNToRecFN__expWidth_5__sigWidth_11__v );
