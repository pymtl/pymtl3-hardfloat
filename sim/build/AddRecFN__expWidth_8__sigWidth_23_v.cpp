//========================================================================
// VAddRecFN__expWidth_8__sigWidth_23_v.cpp
//========================================================================
...
#include "obj_dir_AddRecFN__expWidth_8__sigWidth_23/VAddRecFN__expWidth_8__sigWidth_23.h"
#include "stdio.h"
#include "stdint.h"
#include "verilated.h"
...
#if VLINETRACE
#include "obj_dir_AddRecFN__expWidth_8__sigWidth_23/VAddRecFN__expWidth_8__sigWidth_23__Syms.h"
#include "svdpi.h"
#endif
...
extern "C" {
  ...
  #if VLINETRACE
  void trace( VAddRecFN__expWidth_8__sigWidth_23_t *, char * );
  #endif
...
VAddRecFN__expWidth_8__sigWidth_23_t * create_model( const char *vcd_filename ) {

  VAddRecFN__expWidth_8__sigWidth_23_t * m;
  VAddRecFN__expWidth_8__sigWidth_23   * model;

  Verilated::randReset( 0 );

  m     = (VAddRecFN__expWidth_8__sigWidth_23_t *) malloc( sizeof(VAddRecFN__expWidth_8__sigWidth_23_t) );
  model = new VAddRecFN__expWidth_8__sigWidth_23();
...
void destroy_model( VAddRecFN__expWidth_8__sigWidth_23_t * m ) {

  #if VM_COVERAGE
    VerilatedCov::write( "coverage.dat" );
  #endif

  VAddRecFN__expWidth_8__sigWidth_23 * model = (VAddRecFN__expWidth_8__sigWidth_23 *) m->model;
...
void eval( VAddRecFN__expWidth_8__sigWidth_23_t * m ) {
...
#if VLINETRACE
void trace( VAddRecFN__expWidth_8__sigWidth_23_t * m, char* str ) {
  ...
  svSetScope( &model->__VlSymsp->__Vscope_AddRecFN__expWidth_8__sigWidth_23__v );
