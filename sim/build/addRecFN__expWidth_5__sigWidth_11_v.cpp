//========================================================================
// VaddRecFN__expWidth_5__sigWidth_11_v.cpp
//========================================================================
...
#include "obj_dir_addRecFN__expWidth_5__sigWidth_11/VaddRecFN__expWidth_5__sigWidth_11.h"
#include "stdio.h"
#include "stdint.h"
#include "verilated.h"
...
#if VLINETRACE
#include "obj_dir_addRecFN__expWidth_5__sigWidth_11/VaddRecFN__expWidth_5__sigWidth_11__Syms.h"
#include "svdpi.h"
#endif
...
extern "C" {
  ...
  } VaddRecFN__expWidth_5__sigWidth_11_t;

  // Exposed methods
  VaddRecFN__expWidth_5__sigWidth_11_t * create_model( const char * );
  void destroy_model( VaddRecFN__expWidth_5__sigWidth_11_t *);
  void eval( VaddRecFN__expWidth_5__sigWidth_11_t * );
  void assert_en( bool en );

  #if VLINETRACE
  void trace( VaddRecFN__expWidth_5__sigWidth_11_t *, char * );
  #endif
...
VaddRecFN__expWidth_5__sigWidth_11_t * create_model( const char *vcd_filename ) {

  VaddRecFN__expWidth_5__sigWidth_11_t * m;
  VaddRecFN__expWidth_5__sigWidth_11   * model;

  Verilated::randReset( 0 );

  m     = (VaddRecFN__expWidth_5__sigWidth_11_t *) malloc( sizeof(VaddRecFN__expWidth_5__sigWidth_11_t) );
  model = new VaddRecFN__expWidth_5__sigWidth_11();
...
void destroy_model( VaddRecFN__expWidth_5__sigWidth_11_t * m ) {

  #if VM_COVERAGE
    VerilatedCov::write( "coverage.dat" );
  #endif

  VaddRecFN__expWidth_5__sigWidth_11 * model = (VaddRecFN__expWidth_5__sigWidth_11 *) m->model;
...
void eval( VaddRecFN__expWidth_5__sigWidth_11_t * m ) {
...
#if VLINETRACE
void trace( VaddRecFN__expWidth_5__sigWidth_11_t * m, char* str ) {
  ...
  svSetScope( &model->__VlSymsp->__Vscope_addRecFN__expWidth_5__sigWidth_11__v );
