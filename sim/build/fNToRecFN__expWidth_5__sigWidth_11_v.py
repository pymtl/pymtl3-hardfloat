#=========================================================================
# VfNToRecFN__expWidth_5__sigWidth_11_v.py
#=========================================================================
...
#-------------------------------------------------------------------------
# fNToRecFN__expWidth_5__sigWidth_11
#-------------------------------------------------------------------------

class fNToRecFN__expWidth_5__sigWidth_11( Component ):
  id_ = 0
  ...
  def __init__( s, *args, **kwargs ):
    ...
    #   'libfNToRecFN__expWidth_5__sigWidth_11_v.so', os.path.getmtime( './libfNToRecFN__expWidth_5__sigWidth_11_v.so' ) )

    # Import the shared library containing the model. We defer
    # construction to the elaborate_logic function to allow the user to
    # set the vcd_file.
    s._ffi_inst = s.ffi.dlopen('./libfNToRecFN__expWidth_5__sigWidth_11_v.so')

    # increment instance count
    fNToRecFN__expWidth_5__sigWidth_11.id_ += 1
  ...
  def construct( s, *args, **kwargs ):
    ...
    if 0:
      if False:
        ...
        verilator_vcd_file = "fNToRecFN__expWidth_5__sigWidth_11.verilator1.vcd"
