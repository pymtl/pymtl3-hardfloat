#=========================================================================
# VaddRecFNRTL__expWidth_8__sigWidth_8_v.py
#=========================================================================
...
#-------------------------------------------------------------------------
# addRecFNRTL__expWidth_8__sigWidth_8
#-------------------------------------------------------------------------

class addRecFNRTL__expWidth_8__sigWidth_8( Component ):
  id_ = 0
  ...
  def __init__( s, *args, **kwargs ):
    ...
    #   'libaddRecFNRTL__expWidth_8__sigWidth_8_v.so', os.path.getmtime( './libaddRecFNRTL__expWidth_8__sigWidth_8_v.so' ) )

    # Import the shared library containing the model. We defer
    # construction to the elaborate_logic function to allow the user to
    # set the vcd_file.
    s._ffi_inst = s.ffi.dlopen('./libaddRecFNRTL__expWidth_8__sigWidth_8_v.so')

    # increment instance count
    addRecFNRTL__expWidth_8__sigWidth_8.id_ += 1
  ...
  def construct( s, *args, **kwargs ):
    ...
    if 0:
      if False:
        ...
        verilator_vcd_file = "addRecFNRTL__expWidth_8__sigWidth_8.verilator1.vcd"
    ...
    def comb_upblk():
      ...
      s.s_DOT_out = Bits17(_ffi_m.out[0])
