//========================================================================
// VrecFNToFN__expWidth_8__sigWidth_23_v.cpp
//========================================================================
...
#include "obj_dir_recFNToFN__expWidth_8__sigWidth_23/VrecFNToFN__expWidth_8__sigWidth_23.h"
#include "stdio.h"
#include "stdint.h"
#include "verilated.h"
...
#if VLINETRACE
#include "obj_dir_recFNToFN__expWidth_8__sigWidth_23/VrecFNToFN__expWidth_8__sigWidth_23__Syms.h"
#include "svdpi.h"
#endif
...
extern "C" {
  ...
  } VrecFNToFN__expWidth_8__sigWidth_23_t;

  // Exposed methods
  VrecFNToFN__expWidth_8__sigWidth_23_t * create_model( const char * );
  void destroy_model( VrecFNToFN__expWidth_8__sigWidth_23_t *);
  void eval( VrecFNToFN__expWidth_8__sigWidth_23_t * );
  void assert_en( bool en );

  #if VLINETRACE
  void trace( VrecFNToFN__expWidth_8__sigWidth_23_t *, char * );
  #endif
...
VrecFNToFN__expWidth_8__sigWidth_23_t * create_model( const char *vcd_filename ) {

  VrecFNToFN__expWidth_8__sigWidth_23_t * m;
  VrecFNToFN__expWidth_8__sigWidth_23   * model;

  Verilated::randReset( 0 );

  m     = (VrecFNToFN__expWidth_8__sigWidth_23_t *) malloc( sizeof(VrecFNToFN__expWidth_8__sigWidth_23_t) );
  model = new VrecFNToFN__expWidth_8__sigWidth_23();
...
void destroy_model( VrecFNToFN__expWidth_8__sigWidth_23_t * m ) {

  #if VM_COVERAGE
    VerilatedCov::write( "coverage.dat" );
  #endif

  VrecFNToFN__expWidth_8__sigWidth_23 * model = (VrecFNToFN__expWidth_8__sigWidth_23 *) m->model;
...
void eval( VrecFNToFN__expWidth_8__sigWidth_23_t * m ) {
...
#if VLINETRACE
void trace( VrecFNToFN__expWidth_8__sigWidth_23_t * m, char* str ) {
  ...
  svSetScope( &model->__VlSymsp->__Vscope_recFNToFN__expWidth_8__sigWidth_23__v );
