//========================================================================
// VRecFNToFN__expWidth_5__sigWidth_11_v.cpp
//========================================================================
...
#include "obj_dir_RecFNToFN__expWidth_5__sigWidth_11/VRecFNToFN__expWidth_5__sigWidth_11.h"
#include "stdio.h"
#include "stdint.h"
#include "verilated.h"
...
#if VLINETRACE
#include "obj_dir_RecFNToFN__expWidth_5__sigWidth_11/VRecFNToFN__expWidth_5__sigWidth_11__Syms.h"
#include "svdpi.h"
#endif
...
extern "C" {
  ...
  #if VLINETRACE
  void trace( VRecFNToFN__expWidth_5__sigWidth_11_t *, char * );
  #endif
...
VRecFNToFN__expWidth_5__sigWidth_11_t * create_model( const char *vcd_filename ) {

  VRecFNToFN__expWidth_5__sigWidth_11_t * m;
  VRecFNToFN__expWidth_5__sigWidth_11   * model;

  Verilated::randReset( 0 );

  m     = (VRecFNToFN__expWidth_5__sigWidth_11_t *) malloc( sizeof(VRecFNToFN__expWidth_5__sigWidth_11_t) );
  model = new VRecFNToFN__expWidth_5__sigWidth_11();
...
void destroy_model( VRecFNToFN__expWidth_5__sigWidth_11_t * m ) {

  #if VM_COVERAGE
    VerilatedCov::write( "coverage.dat" );
  #endif

  VRecFNToFN__expWidth_5__sigWidth_11 * model = (VRecFNToFN__expWidth_5__sigWidth_11 *) m->model;
...
void eval( VRecFNToFN__expWidth_5__sigWidth_11_t * m ) {
...
#if VLINETRACE
void trace( VRecFNToFN__expWidth_5__sigWidth_11_t * m, char* str ) {
  ...
  svSetScope( &model->__VlSymsp->__Vscope_RecFNToFN__expWidth_5__sigWidth_11__v );
