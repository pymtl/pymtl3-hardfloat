//========================================================================
// VaddRecFNRTL__expWidth_8__sigWidth_8_v.cpp
//========================================================================
...
#include "obj_dir_addRecFNRTL__expWidth_8__sigWidth_8/VaddRecFNRTL__expWidth_8__sigWidth_8.h"
#include "stdio.h"
#include "stdint.h"
#include "verilated.h"
...
#if VLINETRACE
#include "obj_dir_addRecFNRTL__expWidth_8__sigWidth_8/VaddRecFNRTL__expWidth_8__sigWidth_8__Syms.h"
#include "svdpi.h"
#endif
...
extern "C" {
  ...
  } VaddRecFNRTL__expWidth_8__sigWidth_8_t;

  // Exposed methods
  VaddRecFNRTL__expWidth_8__sigWidth_8_t * create_model( const char * );
  void destroy_model( VaddRecFNRTL__expWidth_8__sigWidth_8_t *);
  void eval( VaddRecFNRTL__expWidth_8__sigWidth_8_t * );
  void assert_en( bool en );

  #if VLINETRACE
  void trace( VaddRecFNRTL__expWidth_8__sigWidth_8_t *, char * );
  #endif
...
VaddRecFNRTL__expWidth_8__sigWidth_8_t * create_model( const char *vcd_filename ) {

  VaddRecFNRTL__expWidth_8__sigWidth_8_t * m;
  VaddRecFNRTL__expWidth_8__sigWidth_8   * model;

  Verilated::randReset( 0 );

  m     = (VaddRecFNRTL__expWidth_8__sigWidth_8_t *) malloc( sizeof(VaddRecFNRTL__expWidth_8__sigWidth_8_t) );
  model = new VaddRecFNRTL__expWidth_8__sigWidth_8();
  ...
  m->exceptionFlags = &model->exceptionFlags;
  m->out = &model->out;
  m->roundingMode = &model->roundingMode;
  m->subOp = &model->subOp;
...
void destroy_model( VaddRecFNRTL__expWidth_8__sigWidth_8_t * m ) {

  #if VM_COVERAGE
    VerilatedCov::write( "coverage.dat" );
  #endif

  VaddRecFNRTL__expWidth_8__sigWidth_8 * model = (VaddRecFNRTL__expWidth_8__sigWidth_8 *) m->model;
...
void eval( VaddRecFNRTL__expWidth_8__sigWidth_8_t * m ) {
...
#if VLINETRACE
void trace( VaddRecFNRTL__expWidth_8__sigWidth_8_t * m, char* str ) {
  ...
  svSetScope( &model->__VlSymsp->__Vscope_addRecFNRTL__expWidth_8__sigWidth_8__v );
